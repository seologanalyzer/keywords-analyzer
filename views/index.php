    ...
    <div class="row-fluid" style="margin-top:10px;">
      <div class="span12 alert alert-success" style="margin:0px;">
        <form method="post" action="/index/addkeyword" style="margin:0;">
          Ajouter un (ou plusieurs) nouveau mot clé:<input type="text" value="" placeholder="seo log analyzer, sla, yolo" name="keyword" class="span3" style="margin:10px;" /><input type="submit" value="Ajouter" />
        </form>
      </div>
    </div>
