...
require_once GG_PATH . 'Google/Api/Ads/Common/Util/SimpleOAuth2Handler.php';
require_once GG_PATH . 'Google/Api/Ads/Common/Lib/SoapClientFactory.php';
require_once GG_PATH . 'Google/Api/Ads/Common/Lib/ValidationException.php';
