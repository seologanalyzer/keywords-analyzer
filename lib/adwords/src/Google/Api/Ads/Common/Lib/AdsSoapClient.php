 ...
 * @author     Vincent Tsao
 */
require_once GG_PATH . 'Google/Api/Ads/Common/Lib/AdsUser.php';
require_once GG_PATH . 'Google/Api/Ads/Common/Util/Logger.php';
require_once GG_PATH . 'Google/Api/Ads/Common/Util/MapUtils.php';
require_once GG_PATH . 'Google/Api/Ads/Common/Util/SoapRequestXmlFixer.php';
require_once GG_PATH . 'Google/Api/Ads/Common/Util/XmlUtils.php';
require_once GG_PATH . 'Google/Api/Ads/Common/Util/DeprecationUtils.php';
