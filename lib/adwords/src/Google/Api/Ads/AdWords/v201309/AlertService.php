...
class AlertService extends AdWordsSoapClient {
  ...
  public static $classmap = array(
    ...
    "mutateCallToAction" => "AlertServiceMutateCallToAction",
    "search" => "AlertServiceSearch",
  ...
  public function __construct($wsdl=null, $options, $user) {
    ...
    parent::__construct($wsdl, $options, $user, 'AlertService', 'https://adwords.google.com/api/adwords/mcm/v201309');
  }
