...
/** Required classes. **/
require_once GG_PATH ."Google/Api/Ads/AdWords/Lib/AdWordsSoapClient.php";
...
if (!class_exists("ExperimentServiceMutate", FALSE)) {
/**
...
class ExperimentServiceError extends ApiError {
  /**
   * @access public
   * @var tnsExperimentServiceErrorReason
   */
  public $reason;
...
if (!class_exists("ExperimentOperation", FALSE)) {
/**
...
class ExperimentService extends AdWordsSoapClient {
  ...
  public static $classmap = array(
    ...
    "mutateCallToAction" => "ExperimentServiceMutateCallToAction",
    "search" => "ExperimentServiceSearch",
   ...
   * @var string
   */
  public static $endpoint = "https://adwords.google.com/api/adwords/cm/v201309/ExperimentService";
  ...
  public function __construct($wsdl=null, $options, $user) {
    ...
    parent::__construct($wsdl, $options, $user, 'ExperimentService', 'https://adwords.google.com/api/adwords/cm/v201309');
  }
