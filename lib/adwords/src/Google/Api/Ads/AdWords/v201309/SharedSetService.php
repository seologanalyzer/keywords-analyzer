...
if (!class_exists("SharedSetServiceMutate", FALSE)) {
/**
 * <span class="constraint ContentsNotNull">This field must not contain {@code null} elements.</span>
...
if (!class_exists("SharedSetOperation", FALSE)) {
/**
 * <span class="constraint Required">This field is required and should not be {@code null}.</span>
 * @package GoogleApiAdsAdWords
 * @subpackage v201309
...
class SharedSetService extends AdWordsSoapClient {
  ...
  public static $classmap = array(
    ...
    "mutateCallToAction" => "SharedSetServiceMutateCallToAction",
    "search" => "SharedSetServiceSearch",
  ...
  public function __construct($wsdl=null, $options, $user) {
    ...
    parent::__construct($wsdl, $options, $user, 'SharedSetService', 'https://adwords.google.com/api/adwords/cm/v201309');
  }
