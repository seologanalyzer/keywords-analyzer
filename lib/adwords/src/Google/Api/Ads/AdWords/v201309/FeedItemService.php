...
class FeedItemService extends AdWordsSoapClient {
  ...
  public static $classmap = array(
    ...
    "mutateCallToAction" => "FeedItemServiceMutateCallToAction",
    "search" => "FeedItemServiceSearch",
  ...
  public function __construct($wsdl=null, $options, $user) {
    ...
    parent::__construct($wsdl, $options, $user, 'FeedItemService', 'https://adwords.google.com/api/adwords/cm/v201309');
  }
