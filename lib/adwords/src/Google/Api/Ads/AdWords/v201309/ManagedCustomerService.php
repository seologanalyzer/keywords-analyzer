...
class ManagedCustomerService extends AdWordsSoapClient {
  ...
  public static $classmap = array(
    ...
    "mutateCallToAction" => "ManagedCustomerServiceMutateCallToAction",
    "search" => "ManagedCustomerServiceSearch",
   ...
   * @var string
   */
  public static $endpoint = "https://adwords.google.com/api/adwords/mcm/v201309/ManagedCustomerService";
  ...
  public function __construct($wsdl=null, $options, $user) {
    ...
    parent::__construct($wsdl, $options, $user, 'ManagedCustomerService', 'https://adwords.google.com/api/adwords/mcm/v201309');
  }
