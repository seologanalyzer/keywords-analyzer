...
class CustomerService extends AdWordsSoapClient {
   ...
   * @var string
   */
  public static $endpoint = "https://adwords.google.com/api/adwords/mcm/v201309/CustomerService";
  ...
  public function __construct($wsdl=null, $options, $user) {
    ...
    parent::__construct($wsdl, $options, $user, 'CustomerService', 'https://adwords.google.com/api/adwords/mcm/v201309');
  }
