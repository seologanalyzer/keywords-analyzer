<?php
/**
 * Contains all client objects for the BudgetService service.
 *
 * PHP version 5
 *
...
if (!class_exists("BudgetServiceMutate", FALSE)) {
/**
...
class BudgetService extends AdWordsSoapClient {
  ...
  public static $classmap = array(
    ...
    "mutateCallToAction" => "BudgetServiceMutateCallToAction",
    "search" => "BudgetServiceSearch",
