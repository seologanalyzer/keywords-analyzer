...
class BiddingStrategyService extends AdWordsSoapClient {
  ...
  public static $classmap = array(
    ...
    "mutateCallToAction" => "BiddingStrategyServiceMutateCallToAction",
    "search" => "BiddingStrategyServiceSearch",
  ...
  public function __construct($wsdl=null, $options, $user) {
    ...
    parent::__construct($wsdl, $options, $user, 'BiddingStrategyService', 'https://adwords.google.com/api/adwords/cm/v201309');
  }
