...
class AdwordsUserListService extends AdWordsSoapClient {
  ...
  public static $classmap = array(
    ...
    "mutateCallToAction" => "AdwordsUserListServiceMutateCallToAction",
    "search" => "AdwordsUserListServiceSearch",
   ...
   * @var string
   */
  public static $endpoint = "https://adwords.google.com/api/adwords/rm/v201309/AdwordsUserListService";
