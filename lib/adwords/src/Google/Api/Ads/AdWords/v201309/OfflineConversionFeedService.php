<?php
/**
 * Contains all client objects for the OfflineConversionFeedService service.
 *
 * PHP version 5
 *
...
class OfflineConversionErrorReason {
   ...
   */
  public function getXsiTypeName() {
    return "OfflineConversionError.Reason";
  }
...
class OfflineConversionFeedReturnValue extends ListReturnValue {
   ...
   */
  public function getXsiTypeName() {
    return "OfflineConversionFeedReturnValue";
  }
...
class OfflineConversionFeedService extends AdWordsSoapClient {
  ...
  public function __construct($wsdl=null, $options, $user) {
    ...
    parent::__construct($wsdl, $options, $user, 'OfflineConversionFeedService', 'https://adwords.google.com/api/adwords/cm/v201309');
  }
