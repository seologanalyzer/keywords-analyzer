...
class DataService extends AdWordsSoapClient {
  ...
  public static $classmap = array(
    ...
    "mutateCallToAction" => "DataServiceMutateCallToAction",
    "search" => "DataServiceSearch",
  ...
  public function __construct($wsdl=null, $options, $user) {
    ...
    parent::__construct($wsdl, $options, $user, 'DataService', 'https://adwords.google.com/api/adwords/cm/v201309');
  }
