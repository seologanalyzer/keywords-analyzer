...
class CampaignSharedSetService extends AdWordsSoapClient {
  ...
  public static $classmap = array(
    ...
    "mutateCallToAction" => "CampaignSharedSetServiceMutateCallToAction",
    "search" => "CampaignSharedSetServiceSearch",
   ...
   * @var string
   */
  public static $endpoint = "https://adwords.google.com/api/adwords/cm/v201309/CampaignSharedSetService";
