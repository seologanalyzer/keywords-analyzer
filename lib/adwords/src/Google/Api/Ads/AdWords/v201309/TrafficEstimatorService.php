...
class TrafficEstimatorService extends AdWordsSoapClient {
  ...
  public static $classmap = array(
    ...
    "mutateCallToAction" => "TrafficEstimatorServiceMutateCallToAction",
    "search" => "TrafficEstimatorServiceSearch",
  ...
  public function __construct($wsdl=null, $options, $user) {
    ...
    parent::__construct($wsdl, $options, $user, 'TrafficEstimatorService', 'https://adwords.google.com/api/adwords/o/v201309');
  }
